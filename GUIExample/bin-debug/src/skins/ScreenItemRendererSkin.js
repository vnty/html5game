...
(function (skins) {
    var ScreenItemRendererSkin = (function (_super) {
        ...
        function ScreenItemRendererSkin() {
            ...
            this.height = 85;
            this.elementsContent = [this.__3_i(), this.labelDisplay_i(), this.__4_i()];
            this.states = [
                new egret.State("up", [
        ...
        ScreenItemRendererSkin.prototype.__4_i = function () {
            ...
            t.right = 22;
            t.source = "list-accessory-drill-down-icon";
            t.verticalCenter = 0;
            return t;
        };
        ...
        ScreenItemRendererSkin.prototype.__3_i = function () {
            var t = new egret.UIAsset();
            this.__3 = t;
            t.percentHeight = 100;
            t.percentWidth = 100;
    ...
    skins.ScreenItemRendererSkin = ScreenItemRendererSkin;
})(skins || (skins = {}));
